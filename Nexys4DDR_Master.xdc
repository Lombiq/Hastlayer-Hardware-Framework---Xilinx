...
#set_false_path -from [get_clocks -of_objects [get_pins Hastlayer_i/clk_wiz_1/U0/mmcm_adv_inst/CLKOUT0] -filter {IS_GENERATED && MASTER_CLOCK == sys_clk_pin}] -to [get_clocks -of_objects [get_pins Hastlayer_i/clk_wiz_1/U0/mmcm_adv_inst/CLKOUT0] -filter {IS_GENERATED && MASTER_CLOCK == sys_clk_pin}]
